...
List<AutoRoute> section2Routes(Ref ref) => [
      ...
      AutoRoute(page: Exercise20LoginRoute.page),
      AutoRoute(page: Exercise20RegistrationCompleteRoute.page),
      AutoRoute(page: Exercise21Route1.page),
      AutoRoute(page: Exercise21ConfirmationRoute.page),
    ];
